...
<head>
    ...
    <script type="text/javascript">var menu_nbr = 4;</script>

    <?php include('includes/head.html'); ?>
</head>

<body class="para-quien-lo-hacemos">
    <?php include('includes/header.html'); ?>

    <div class="container cuerpo">
        <div class="row">
            <div class="col-sm-3 para-izq hidden-xs">
                <div class="muneco-para">
                    <img src="img/logo-dos-munecos.png" class="img-responsive" />
                </div>
            </div>
    ...
    <div class="container cuerpo carrusel-individual hidden-xs">
        <div class="row para-carr-1">
            <div class="col-xs-12 col-sm-12 col-md-10 para-listado para-listado-texto">
                <h2 class="naranja helvetica-light">Profesionales Técnicos</h2>
                <p>Porque con ETC. los Estudios de Arquitectura, Ingeniería y Aparejadores estarán volcados en su trabajo y no en las gestiones.</p>
            </div>
            ...
            <div class="col-md-2 para-listado-icono para-listado hidden-xs hidden-sm">
                <img src="img/entidades-financieras.png" class="img-responsive center-block" />
            </div>
        </div>

        <div class="row para-carr-2">
            <div class="col-xs-12 col-sm-12 col-md-10 para-listado para-listado-texto">
                <h2 class="naranja helvetica-light">Comunidades de Propietarios <span class="negro">|</span> Administradores de fincas</h2>
                <p>Porque delegas las gestiones más importantes en un profesional del sector.</p>
            </div>
            <div class="col-md-2 para-listado-icono para-listado hidden-xs hidden-sm">
            ...
            <div class="col-md-2 para-listado-icono para-listado hidden-xs hidden-sm">
                <img src="img/etcetera.png" class="img-responsive center-block" />
            </div>
        </div>
    </div>

    <div class="container cuerpo visible-xs">
        <div class="row para-carr-1">
            <div class="col-xs-12 col-sm-12 col-md-10 para-listado para-listado-texto">
                <h2 class="naranja helvetica-light">Profesionales Técnicos</h2>
                <p>Porque con ETC. los Estudios de Arquitectura, Ingeniería y Aparejadores estarán volcados en su trabajo y no en las gestiones.</p>
